...
public class Word {
    ...
    /**
     *  defaultTranslationId is the string resource ID for the word in a language that the
     *                             user is already familiar with (such as English)
     *  miwokTranslationId is the string resource Id for the word in the Miwok language
